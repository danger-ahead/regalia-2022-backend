...
def send_mail(mail, name, uid, allowed):
    try:
        ...
        t = requests.post(
            ...
            files=[("attachment", open("routes/resend_email_scripts/templates/pass.png", "rb")), ("attachment", open("routes/resend_email_scripts/templates/promotional.jpg", "rb"))],
            data={
                "from": "Regalia'22 Team <no-reply-regaila-pass@" + env_config.mailgun_domain + ">",
                "to": [mail],
